...
for rainy_day in rainy_days:
    ...
    f_w.write(rainy_day + ', ' + '{:.4f}'.format(rainy_day_imgs_nonzero_points) + ', ' + '{:.4f}'.format(rainy_day_imgs_nparr_mean) + ', ' + '{:.4f}'.format(rainy_day_imgs_nparr_nonzero_mean) + '\n')
f_r.close()
f_w.close()