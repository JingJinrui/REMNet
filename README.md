...
Our pretrained model can be downloaded from link [HKO-7](https://k00.fr/kiw5oejy) and [Shanghai-2020](https://k00.fr/j8rym7j0), please put them into the <code>checkpoints</code> folder to test.
