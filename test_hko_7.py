...
def test(test_samples_only=True, dBZ_threshold=10, eval_ssim=False):
    ...
    test_samples_dataset = datasets.HKO_7_samples(config.test_samples_dir)
    ...
    if not test_samples_only:
        ...
        test_dataset = datasets.HKO_7(config.dataset_root, seq_len=config.seq_len, seq_interval=config.seq_interval,
                                      train=False,
