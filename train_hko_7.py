...
from configs import config_hko as config
...
def train():
    ...
    train_dataset = datasets.HKO_7(config.dataset_root, seq_len=config.seq_len, seq_interval=config.seq_interval,
                                   train=True,
    ...
    valid_dataset = datasets.HKO_7(config.dataset_root, seq_len=config.seq_len, seq_interval=config.seq_interval,
                                   train=False,
